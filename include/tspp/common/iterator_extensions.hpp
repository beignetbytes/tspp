...
namespace tspp {
    namespace iterator_extensions {
        ...
        class iterator_pair
            ...
            std::pair<typename std::iterator_traits<Iterator1>::value_type,
        ...
        template <class Iterator1, class Iterator2>
        iterator_pair<Iterator1, Iterator2>
            make_iterator_pair(const std::pair<Iterator1, Iterator2>& it_pair) {
            return (iterator_pair<Iterator1, Iterator2>(it_pair));
        };

        template <class Iterator1, class Iterator2>
        iterator_pair<Iterator1, Iterator2>
            make_iterator_pair(std::pair<Iterator1, Iterator2>&& it_pair)
        {
            return (iterator_pair<Iterator1, Iterator2>(it_pair));
        };
    };
