...
#pragma region Precondition macro
	...
	class time_series_error : public std::exception {
	  public:
		time_series_error(const std::string &file, long line, const std::string &functionName, const std::string &message = "")
	  ...
	  private:
		...
		static std::string format(
			...
			const std::string &file, long line, const std::string &function, const std::string &message) {
