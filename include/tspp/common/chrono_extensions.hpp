	...
	namespace chrono_extensions {
		...
		class gen_helpers {
			public:
				...
				static std::function<std::pair<tspp::enums::ordering, iterright>(iterleft, iterright, iterright)> merge_asof_frontend(const duration_type& duration, func_in  func) {
					return[=](iterleft left, iterright right, iterright right_other) -> std::pair<tspp::enums::ordering, iterright> {return func(left, right, right_other, duration); };
				};
		};
		...
		class merge_helpers {
			private:
				...
				static std::pair<tspp::enums::ordering,iterright> merge_asof_prior_impl(iterleft itl, iterright itr, iterright itr_prior, const duration_type& duration) {
				...
				template<class iterleft, class iterright, class duration_type>
				static std::pair<tspp::enums::ordering, iterright> merge_asof_fwd_impl(iterleft itl, iterright itr, iterright itr_peek, const duration_type& duration) {
			...
			public:
				...
				static auto merge_asof_prior(const duration_type& look_back) { 
					return  gen_helpers::merge_asof_frontend<iterleft, iterright, duration_type>(look_back, merge_helpers<time_type, time_arty_type>::merge_asof_prior_impl<iterleft, iterright, duration_type>);
				};
				...
				static std::function<std::pair<tspp::enums::ordering, iterright>(iterleft, iterright, iterright)> merge_asof_fwd(const duration_type& look_fwd) {
					return  gen_helpers::merge_asof_frontend<iterleft, iterright, duration_type>(look_fwd, merge_helpers<time_type, time_arty_type>::merge_asof_fwd_impl<iterleft, iterright, duration_type>);
				};
		};
